---
title             : "Advancing Open-Source Authorship: <add more here>"
shorttitle        : "Advancing Open-Source Authorship"
...
- There is a strong traditional of making educational materials open

- In software and statistics, open access is a norm, which sets a precedent for publishers

- Where it comes to code, print has limitations

- There is presently a strong push toward open-access with respect to publishing in journals

- Many educational research faculty require publications for tenure and promotion

In earlier posts, we shared how we wrote [*Data Science in Education Using
R*](http://datascienceineducation.com/) as an open book
...
the R community^[https://bookdown.org/yihui/rmarkdown/]
^[https://geocompr.robinlovelace.net/] ^[http://adv-r.had.co.nz/]
...
book](https://github.com/data-edu/data-science-in-education/), it was easy for
...
[{bookdown}](https://bookdown.org/) and [Netlify](https://www.netlify.com/) to
share the book as a website. Additionally, we chose an easy-to-remember URL
(<http://datascienceineducation.com/>) to help others (and us!) to be able to
access it easily.
...
datum)](https://github.com/data-edu/data-science-in-education/issues/20). Other
...
authors, 15 individuals made contributions, and another 144 individuals starred
the
repository^[https://joshuamrosenberg.com/posts/data-science-in-education-using-r-by-and-beyond-the-numbers/].
...
an R package, [{dataedu}](https://data-edu.github.io/dataedu/), to accompany the
...
^[https://books.google.com/books?hl=en\&lr=\&id=bjMsCKvV9I4C\&oi=fnd\&pg=PR5\&dq=DIBONA,+C.,+OCKMAN,+S.,+AND+STONE,+M.+1999.+Open+Sources:+Voices+from+the+Open+Source+Revolution.+O%E2%80%99Reilly,+Sebastopol,+Calif.\&ots=D\_l\_LXcDtB\&sig=zu1hkYJlSrqCUaxe3nYbProHlg8].
...
issues^[https://dl.acm.org/doi/abs/10.1145/567793.567795]; proportions
...
^[https://journals.sagepub.com/doi/full/10.1177/2332858418787466]. Related to
open science are open scholarly practices. Others trace the origin of the idea of
open scholarly practices to [a book by Boyer](https://eric.ed.gov/?id=ED326149),
...
^[https://hewlett.org/strategy/open-education/]. These resources range from
...
new one)
^[https://www.tandfonline.com/doi/full/10.1080/02680510903482132?casa\_token=S0sRaVJZiA4AAAAA%3ABO-fx7uNOQoNEdXl5-aQ8ooYpfTFohZdefU-ZJROwFDo3XL-W2oAbaOb3Un\_DwRItNN4gj8eBXUo9A].
...
Books](https://edtechbooks.org). There are increasing conversations related to
...
- Cultural change around publishing
